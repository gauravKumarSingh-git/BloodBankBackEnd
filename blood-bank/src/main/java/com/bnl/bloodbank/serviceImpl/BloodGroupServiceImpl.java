...
public class BloodGroupServiceImpl implements BloodGroupService {
    ...
    public String deleteBloodGroup(long bloodGroupId) throws NotPresentException {
        BloodGroup fromRepo = getBloodGroup(bloodGroupId);
        bloodGroupRepository.delete(fromRepo);
    ...
    public BloodGroup getByBloodGroup(String bloodGroup) throws NotPresentException {
        Optional<BloodGroup> fromRepo = bloodGroupRepository.findByBloodGroup(bloodGroup);
        return fromRepo.orElseThrow(()-> new NotPresentException("Blood Group " + bloodGroup + " not present"));
    }
