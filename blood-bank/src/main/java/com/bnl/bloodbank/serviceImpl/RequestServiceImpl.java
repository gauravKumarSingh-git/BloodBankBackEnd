...
public class RequestServiceImpl implements RequestService {
    ...
    public String updateStatus(long requestId, String status) throws NotPresentException {
        Optional<Request> fromRepo = requestRepository.findById(requestId);
        Request request = fromRepo.orElseThrow(() -> new NotPresentException("Request for id " + requestId + " not found"));
